            ...
            <form method="post">
                <div class="empresa">
                    ...
                    <div id="table1">
                        <table >
                            Inserte su CIF:<br>
                            <input type="text" name="cif" name="cif"/><br>
                        </table>
                    </div>
                    <?php
                        //Consulta para recuperar la contrasena
                        if (isset($_POST['enviar'])) {
                            $cif=$_POST['cif'];
                            $sql="SELECT `email`, `contrasena` FROM `empresas` "
                                . "WHERE `cif`='".$cif."'";
                            ...
                            echo ($fila != NULL) ? mail($email, 'Recuperación de Contraseña', $mensaje, 'From: AgenciaTelde <info@address.com>') : (
                                //Si DNI está vacío
                                ($dni=="") ? "<p>Inserte DNI</p>" : "<p>CIF no registrado.</p>");
                        }
                    ?>
                    <div class="submit">
