                ...
                <div id="datos">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><?php echo (isset($row['nivelformativo'])) ? $row['nivelformativo'] : ''; ?></td>
                        </tr><tr>
                    ...
                    $rowCertificado = mysqli_fetch_array($resultCertificado, MYSQLI_ASSOC);
                    ?>
                    <br/><legend>Formación complementaria</legend>
                    <table>
                        <tr>
                            <td class="title1" rowspan="3">Certificado:</td>
                            <?php echo ($rowCertificado = mysqli_fetch_array($resultCertificado, MYSQLI_ASSOC)) ? "<td>" . $rowFormacion['certificado'] . "</td>" : "<td>--</td>"; 
                                  echo ($rowCertificado = mysqli_fetch_array($resultCertificado, MYSQLI_ASSOC)) ? "</tr><tr><td>" . $rowFormacion['certificado'] . "</td>" : "</tr><tr><td>--</td>"; 
                                  echo ($rowCertificado = mysqli_fetch_array($resultCertificado, MYSQLI_ASSOC)) ? "</tr><tr><td>" . $rowFormacion['certificado'] . "</td>" : "</tr><tr><td>--</td>"; ?>
                        </tr><tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <?php echo ($rowPerfilPro = mysqli_fetch_array($resultPerfilPro, MYSQLI_ASSOC)) ? "<td>" . $rowFormacion['perfilprofesional'] . "</td>" : "<td>--</td>"; 
                                  echo ($rowPerfilPro = mysqli_fetch_array($resultPerfilPro, MYSQLI_ASSOC)) ? "</tr><tr><td>" . $rowFormacion['perfilprofesional'] . "</td>" : "</tr><tr><td>--</td>"; 
                                  echo ($rowPerfilPro = mysqli_fetch_array($resultPerfilPro, MYSQLI_ASSOC)) ? "</tr><tr><td>" . $rowFormacion['perfilprofesional'] . "</td>" : "</tr><tr><td>--</td>"; ?>
                        </tr><tr>
